            ...
            <div className="w-full max-w-[450px]">
                ...
                <div className="premium-card flex flex-col items-center">
                    <div className="mb-8 text-center w-full">
                        <h1 className="text-4xl font-sans font-black uppercase mb-2 leading-none">Register</h1>
                        <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground">Select your division to create an account</p>
                    </div>
                ...
                <p className="text-center mt-6 text-xs font-bold uppercase tracking-widest text-muted-foreground">
                    Already have an account? <Link href="/login" className="text-black hover:underline underline-offset-4">Sign in here</Link>
                </p>
            </div>
        </div>
    );
